...
let removedDupli = [...new Set(categories)];

removedDupli.unshift("All");

function buttoneBtn() {
  removedDupli.forEach((removedDupli) => {
    let btn = document.createElement("button");
    btn.setAttribute("class", "btn btn-outline-dark btn-item");
    btn.setAttribute("id", removedDupli);

    btn.innerHTML = removedDupli;
    btn.setAttribute("data-id", removedDupli);
    btnContainer.appendChild(btn);
  });
}
buttoneBtn();

function menuItemGo(menu) {
  menu.forEach((item) => {
